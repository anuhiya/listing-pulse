...
**Live geocoding search** — type any real NYC address like "NYU Tandon" or "Columbia University" and the commute ring draws around that exact location using the Mapbox Geocoding API.
